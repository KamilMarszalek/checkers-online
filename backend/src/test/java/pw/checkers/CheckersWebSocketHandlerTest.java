...
public class CheckersWebSocketHandlerTest {
    ...
    public void testHandleJoinQueue_NoWaitingPlayer() throws Exception {
        ...
        String jsonPayload = "{\"type\":\"joinQueue\",\"content\":{\"user\":{\"username\":\"Alice\"}}}";
        ...
        assertTrue(((PromptMessage) sentMessage.getContent()).getMessage().contains("Waiting for an opponent"));
    }
    ...
    public void testHandleMove_NoAssignedColor() throws Exception {
        ...
        String jsonPayload = "{\"type\":\"move\",\"content\":{\"gameId\":\"" + gameId + "\",\"move\":{\"fromRow\":5,\"fromCol\":2,\"toRow\":4,\"toCol\":3}}}";        // Stub getAssignedColor to return empty.
        when(sessionManager.getAssignedColor(eq(gameId), eq(session))).thenReturn(Optional.empty());
    ...
    public void testHandlePossibilities_Valid() throws Exception {
        ...
        String gameId = "game123";
        String jsonPayload = "{\"type\":\"possibilities\",\"content\":{\"gameId\":\"" + gameId + "\",\"row\":2,\"col\":3}}";
        ...
        PossibleMoves dummyMoves = new PossibleMoves();
    ...
    public void testHandleLeaveQueue() throws Exception {
        ...
        String jsonPayload = "{\"type\":\"leaveQueue\",\"content\":{\"user\":{\"username\":\"Alice\"}}}";
        handler.handleTextMessage(session, new TextMessage(jsonPayload));
    ...
    public void testHandleRematchDecline() throws Exception {
        ...
        String gameId = "game123";
        String jsonPayload = "{\"type\":\"decline rematch\",\"content\":{\"gameId\":\"" + gameId + "\"}}";
        handler.handleTextMessage(session, new TextMessage(jsonPayload));
    ...
    public void testHandleUnknownMessageType() throws Exception {
        ...
        String jsonPayload = "{\"type\":\"unknownType\",\"content\":{}}";
        handler.handleTextMessage(session, new TextMessage(jsonPayload));
        ...
        assertTrue(sentMessage.getContent().toString().contains("Unknown message type"));
    }
}
