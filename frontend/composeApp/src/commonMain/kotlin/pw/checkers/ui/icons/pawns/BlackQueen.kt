...
public val Pawns.BlackQueen: ImageVector
    get() {
        if (_blackqueen != null) {
            return _blackqueen!!
        }
        _blackqueen = Builder(name = "Blackqueen", defaultWidth = 257.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFFff0000)), stroke = null, fillAlpha = 0.5f,
...
private var _blackqueen: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Pawns.BlackQueen, contentDescription = "")
    }
}
